...
<div class="support-info">
		<!-- container -->
		<div class="container">
			<form:form action="update_category" method="post" modelAttribute="category" class="form-horizontal">
			 <table class="table">
					<thead>
						<tr>
					...
					<tbody>
					 <c:forEach items="${categoryDAO}" var="category">
					    <tr>
							...
							<td align="left"><a href="update_category?id=${category.id }&name=${category.name }">Update</a></td>
						</tr>
					 </c:forEach>
